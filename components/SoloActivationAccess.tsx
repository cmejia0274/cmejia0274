      ...
      <section className="py-20">
        <div className="max-w-3xl mx-auto px-6 space-y-12">
          ...
          <div className="p-10 md:p-14 bg-[#003456] text-white rounded-[3rem] shadow-2xl relative overflow-hidden">
            ...
            <h2 className="text-2xl md:text-3xl font-black mb-10 uppercase tracking-tight">Individual Operating Diagnostic</h2>
            ...
            <div className="space-y-6 text-base md:text-lg font-medium opacity-90 leading-relaxed mb-12">
              ...
              <div className="py-6 border-y border-white/10 space-y-4">
                ...
                <ul className="space-y-3 font-bold">
                  ...
                  <li className="flex gap-3 items-center"><span className="text-[#7edb44]">•</span> We meet for a 30-minute executive debrief</li>
                </ul>
              </div>
              
              <div className="pt-2">
                <p className="text-xs font-black text-white/50 uppercase tracking-widest mb-3">From there, the next move becomes clear:</p>
          ...
          <div className="text-xl md:text-2xl text-[#003456] font-medium leading-relaxed space-y-8">
            <p>
              Between now and then, you don’t need to change your calendar, your workflow, or your behavior. In fact, the more normally you operate, the more useful this will be. Instructions and your starting prompt will be sent immediately.
            </p>
