...
const HomePage: React.FC = () => {
  return (
    <div className="flex flex-col min-h-screen bg-white text-[#003456]">
      {/* Top Banner - Institutional Style */}
      <div className="bg-[#7edb44] text-[#003456] py-4 px-6 sticky top-20 z-40 shadow-md">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-4">
          <div className="flex items-center">
            <p className="text-xs md:text-sm font-black uppercase tracking-[0.2em] leading-tight text-center lg:text-left">
              FOUNDING ACTIVATION COHORT — APRIL 6, 2026
            </p>
          </div>
          <div className="flex flex-col sm:flex-row items-center gap-4 md:gap-8">
            <p className="text-xs md:text-sm font-bold uppercase tracking-widest opacity-90 hidden sm:block">
              Limited seats at founding rates.
            </p>
            <Link 
              to="/activation" 
